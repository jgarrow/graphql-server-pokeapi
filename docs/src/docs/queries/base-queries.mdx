...
| learn_methods           | --        | [MoveLearnMethod](#MoveLearnMethod) | Use in a `moves` query on a `Pokemon` type: returns an array of `MoveLearnMethod` types for how a Pokémon learns this move                                                         |
...
| pokedex_entries    | --             | [DexEntry](#dexentry)                   | Returns an array of `DexEntry` objects                                                                                                                                   |
...
| dominant_color     | --             | [Dominant_Color](#dominant_color)       | Returns a `DominantColor` object                                                                                                                                         |
...
| evolution_criteria | --             | [EvolutionCriteria](#evolutioncriteria) | Returns an array of `EvolutionCriteria` objects for the criteria that must have been met for this Pokémon to have evolved                                                |
| base_stats         | --             | [Stats](#stats)                         | Returns a `Stat` object for this Pokémon; returns `null` if database is incomplete                                                                                       |
